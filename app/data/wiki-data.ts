...
export const ALL_PLACES_DATA = [
    ...
    { name: "Amu", description: "An elegant archipelago kingdom known for its powerful navy and the tragic Princess Kikomi.", image: "/places/amu.jpeg", link: "/places/amu", category: "state" },
    { name: "Cocru", description: "A vast, martial state on the Big Island, homeland of both Kuni Garu and Mata Zyndu.", image: "/places/cocru.jpeg", link: "/places/cocru", category: "state" },
    { name: "Faca", description: "A northern kingdom known for treacherous politics and its unique mastery of the silkmotic force.", image: "/places/faca.jpeg", link: "/places/faca", category: "state" },
    { name: "Gan", description: "The wealthiest of the Tiro states, a land of merchants whose loyalty is often driven by profit.", image: "/places/gan.jpeg", link: "/places/gan", category: "state" },
    { name: "Haan", description: "The intellectual heart of Dara, a kingdom of scholars, inventors, and the home of Luan Zya.", image: "/places/haan.jpeg", link: "/places/haan", category: "state" },
    { name: "Rima", description: "A forested northern kingdom whose fisherman-king, Jizu, became a martyr for the rebellion.", image: "/places/rima.jpeg", link: "/places/rima", category: "state" },
    { name: "Xana", description: "The powerful island nation that first conquered Dara and established the Xana Empire.", image: "/places/xana.jpeg", link: "/places/xana", category: "state" },
    // Major Cities & Regions of Dara
    { name: "Pan", description: "The grand Imperial Capital of Dara, built by the Xana and later the seat of the Dandelion Dynasty.", image: "/places/pan.jpeg", link: "/places/pan", category: "city" },
    { name: "Zudi", description: "A major city in Cocru and the hometown of Kuni Garu, Jia Matiza, and other key figures.", image: "/places/zudi.jpeg", link: "/places/zudi", category: "city" },
    { name: "Caruza", description: "The ancient capital of Cocru, which served as the political headquarters for the Dandelion Rebellion.", image: "/places/caruza.jpeg", link: "/places/caruza", category: "city" },
    { name: "Ginpen", description: "The capital of Haan, a center of learning that later hosts a grassroots cultural and technological renaissance.", image: "/places/ginpen.jpeg", link: "/places/ginpen", category: "city" },
    { name: "Dimushi", description: "A bustling port city and the hometown of Gin Mazoti, with a thriving criminal underworld.", image: "/places/dimushi.jpeg", link: "/places/dimushi", category: "city" },
    { name: "Kriphi", description: "The capital of the Xana home island of Rui, later the seat of the Lyucu occupation.", image: "/places/kriphi.jpeg", link: "/places/kriphi", category: "city" },
    { name: "Nokida", description: "The capital of Géjira and Queen Gin Mazoti's seat of power.", image: "/places/nokida.jpeg", link: "/places/nokida", category: "city" },
    { name: "Gefica", description: "A rich territory that was the subject of the 'Princeps's Promise,' a catalyst for the civil war.", image: "/places/gefica.jpeg", link: "/places/gefica", category: "city" },
    { name: "Gejira", description: "The powerful kingdom granted to Marshal Gin Mazoti after the Dandelion Rebellion.", image: "/places/gejira.jpeg", link: "/places/gejira", category: "city" },
    // Outer Islands & Archipelagos of Dara
    { name: "Dasu", description: "A remote island of exile that Kuni Garu transformed into the crucible of the Dandelion Dynasty.", image: "/places/dasu.jpeg", link: "/places/dasu", category: "island" },
    { name: "Rui", description: "The Xana homeland and the sole source of the mystical lift gas for Dara's airships.", image: "/places/rui.jpeg", link: "/places/rui", category: "island" },
    { name: "Arulugi", description: "The capital island of Amu, site of a key naval battle and a later rebellion.", image: "/places/arulugi.jpeg", link: "/places/arulugi", category: "island" },
    { name: "Crescent Island", description: "A remote northern island used for Zomi Kidosu's education and the site of a major battle in the Lyucu War.", image: "/places/crescent-island.jpeg", link: "/places/crescent-island", category: "island" },
    { name: "Ecofi Island", description: "The small island where Emperor Mapidéré died, sparking the coup that ended his dynasty.", image: "/places/ecofi-island.jpeg", link: "/places/ecofi-island", category: "island" },
    { name: "Tan Adu", description: "A remote southern island inhabited by the legendary cruben-riding people.", image: "/places/tan-adu.jpeg", link: "/places/tan-adu", category: "island" },
    { name: "Tunoa Islands", description: "The ancestral island fiefdom of the Zyndu Clan and the place where Mata Zyndu was raised.", image: "/places/tunoa-islands.jpeg", link: "/places/tunoa-islands", category: "island" },
    { name: "Wolf's Paw", description: "A southern island, site of a major battle and one of Mata Zyndu's most horrific atrocities.", image: "/places/wolfs-paw.jpeg", link: "/places/wolfs-paw", category: "island" },
    // Geographical Landmarks of Dara
    { name: "Kishi Channel", description: "A treacherous strait with a permanent whirlpool, where Mata Zyndu made a horrific sacrifice.", image: "/places/kishi-channel.jpeg", link: "/places/kishi-channel", category: "landmark" },
    { name: "Lake Dako", description: "A mystical crater lake on Mount Kiji, the sole source of airship lift gas.", image: "/places/lake-dako.jpeg", link: "/places/lake-dako", category: "landmark" },
    { name: "Lake Tututika", description: "The sacred lake on whose shores the imperial capital, Pan, was built.", image: "/places/lake-tututika.jpeg", link: "/places/lake-tututika", category: "landmark" },
    { name: "Liru River", description: "A major river that served as the strategic border during the standoff between Kuni Garu and Mata Zyndu.", image: "/places/liru-river.jpeg", link: "/places/liru-river", category: "landmark" },
    { name: "Mount Kiji", description: "A sacred volcano on Rui, the strategically vital source of the lift gas for airships.", image: "/places/mount-kiji.jpeg", link: "/places/mount-kiji", category: "landmark" },
    { name: "Roro Hills", description: "A strategic region in occupied Dara that served as the Lyucu's final stronghold.", image: "/places/roro-hills.jpeg", link: "/places/roro-hills", category: "landmark" },
    { name: "Thoco Pass", description: "The mountain pass where the legendary Marshal Dazu Zyndu was famously betrayed by his own king.", image: "/places/thoco-pass.jpeg", link: "/places/thoco-pass", category: "landmark" },
    { name: "Zathin Gulf", description: "The site of the climactic naval battle against the first Lyucu invasion, where Emperor Ragin died.", image: "/places/zathin-gulf.jpeg", link: "/places/zathin-gulf", category: "landmark" },
    // Lands Beyond the Wall of Storms
    { name: "Ukyu & Gonde", description: "The vast, harsh continent across the sea, home to the Lyucu and Agon peoples.", image: "/places/ukyu-gonde.jpg", link: "/places/ukyu-gonde", category: "beyond" },
    { name: "Kiri Valley", description: "A hidden valley in the World's Edge Mountains that served as the secret base for the Agon rebellion.", image: "/places/kiri-valley.jpeg", link: "/places/kiri-valley", category: "beyond" },
    { name: "Lurodia Tanta", description: "The vast desert in Ukyu-Gondé where the exiled Agon tribes live.", image: "/places/lurodia-tanta.jpeg", link: "/places/lurodia-tanta", category: "beyond" },
    { name: "Sea of Tears", description: "A large inland sea in Ukyu-Gondé surrounded by mysterious, ancient geoglyphs.", image: "/places/sea-of-tears.jpeg", link: "/places/sea-of-tears", category: "beyond" },
    { name: "Sliyusa Ki", description: "A major oasis in the Lurodia Tanta desert and the first center of the Agon resistance.", image: "/places/sliyusa-ki.jpeg", link: "/places/sliyusa-ki", category: "beyond" },
    { name: "Taten", description: "The roaming tent-city and capital of the Lyucu pékyu, from which the invasion of Dara was planned.", image: "/places/taten.jpeg", link: "/places/taten", category: "beyond" },
    { name: "Taten-ryo-alvovo", description: "The 'City of Ghosts,' an ancient, ruined city where the Agon rediscovered their true history.", image: "/places/taten-ryo-alvovo.jpeg", link: "/places/taten-ryo-alvovo", category: "beyond" },
    { name: "World's Edge Mountains", description: "A massive mountain range in Ukyu-Gondé that served as a refuge for Théra's rebellion.", image: "/places/worlds-edge-mountains.jpeg", link: "/places/worlds-edge-mountains", category: "beyond" },
    // Etc
    { name: "Last Bite", description: "A secret Imperial research facility where Kinri's and Zomi's true parentage was revealed.", image: "/places/last-bite.jpeg", link: "/places/last-bite", category: "etc" },
    { name: "Tiro Cozo", description: "The secret base where Emperor Phyro established his garinafin breeding program in defiance of the regent.", image: "/places/tiro-cozo.jpeg", link: "/places/tiro-cozo", category: "etc" },
    { name: "Kigo Yezu", description: "A Dara village in occupied Rui that was the site of a horrific massacre during the Lyucu purges.", image: "/places/kigo-yezu.jpeg", link: "/places/kigo-yezu", category: "etc" },
];
