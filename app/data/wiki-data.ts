...
export const CHARACTERS_BY_BOOK_NAV = {
    ...
    TVT: [
        ...
        { name: "Goztan Ryoto", description: "A powerful Lyucu thane who navigates the treacherous politics of the occupation.", image: "/characters/goztan-ryoto.png", link: "/characters/goztan-ryoto" },
    ],
    SB: [
