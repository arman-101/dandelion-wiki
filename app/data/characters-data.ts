...
// This defines the 'shape' of our character data for consistency
...
// This object will hold the data for all characters
export const charactersData: { [key: string]: Character } = {
    ...
    // We will add data for other characters like Mata Zyndu here later
};