...
// Add imports for the icons from a library like heroicons
// e.g., import { BookOpenIcon, UsersIcon, MapIcon, SparklesIcon, LightBulbIcon } from '@heroicons/react/24/outline';
import { ALL_WIKI_PAGES } from './data/wiki-data';

// Define the types for the Icon component's props to fix the 'implicit any' errors.
type IconProps = {
  name: 'book' | 'users' | 'map' | 'sparkles' | 'light-bulb';
  className: string;
};
...
const Icon = ({ name, className }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {name === 'map' && <path strokeLinecap="round" strokeLinejoin="round"d="M9 6.75V15m6-6v8.25m.5-12.75h-7A2.25 2.25 0 003.75 6v12a2.25 2.25 0 002.25 2.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75h-7A2.25 2.25 0 009 6.75z" />}
    {name === 'sparkles' && <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.622L16.5 21.75l-.398-1.128a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.128-.398a2.25 2.25 0 001.423-1.423L16.5 15.75l.398 1.128a2.25 2.25 0 001.423 1.423L19.5 18.75l-1.128.398a2.25 2.25 0 00-1.423 1.423z" />}
    {name === 'light-bulb' && <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.184m-1.5.184a6.01 6.01 0 01-1.5-.184m3.75 7.375a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />}
  </svg>
);
...
export default function HomePage() {
  ...
  // Reusable classes for the navigation cards for consistency
        ...
        <div className="mt-12">
            ...
            <div className="grid gap-6 md:grid-cols-3">
                ...
                <Link href="/places" className={cardClasses}>
                    <Icon name="map" className={iconClasses} />
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
                <Link href="/gods" className={cardClasses}>
                    <Icon name="sparkles" className={iconClasses} />
                ...
                <Link href="/concepts" className={cardClasses}>
                    <Icon name="light-bulb" className={iconClasses} />
