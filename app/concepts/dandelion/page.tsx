...
const conceptData: Concept = {
    ...
    details: [
        { type: 'text', content: "The dandelion philosophy is first introduced by Jia Matiza, who teaches Kuni Garu about the plant's remarkable qualities during their courtship. She admires the dandelion for its hardiness, versatility, and resourcefulness - qualities she sees reflected in Kuni's character." },
        { type: 'ref', data: { book: "The Grace of Kings", chapter: 4, link: "/books/the-grace-of-kings#chapter-4" } },
        { type: 'text', content: " Unlike the noble chrysanthemum, which represents tradition and aristocratic values, the dandelion is a common flower that grows in the most unlikely places. It can survive harsh conditions, spread its seeds far and wide, and transform barren ground into fields of gold. This resilience and adaptability becomes the foundation of Kuni's approach to leadership and governance." },
        ...
        { type: 'text', content: " This philosophy directly influences Kuni's policies as emperor, leading to the establishment of the Grand Examination system that selects officials based on merit rather than birth, the promotion of innovation and technological advancement, and a focus on improving the lives of ordinary citizens rather than glorifying the nobility." },
        { type: 'ref', data: { book: "The Wall of Storms", chapter: 8, link: "/books/the-wall-of-storms#chapter-8" } },
        { type: 'text', content: " The dandelion becomes the official symbol of the Dandelion Dynasty, representing Kuni's vision of a world where the lowly can rise to greatness through their own efforts and where innovation and compassion are valued above tradition and force. It stands in direct contrast to Mata Zyndu's chrysanthemum philosophy, creating the central ideological conflict of the series." },
        { type: 'ref', data: { book: "The Grace of Kings", chapter: 51, link: "/books/the-grace-of-kings#chapter-51" } },
    ]
};
