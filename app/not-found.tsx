    ...
    return (
        <div className="flex flex-col items-center justify-center text-center py-20">
            ...
            <div className="mt-10">
                <Link
                    href="/"
                    className="rounded-md bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-light focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                >
                    Go back home
                </Link>
            </div>
