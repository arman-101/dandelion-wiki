...
const chapters = [
    ...
    },
    {
        ...
        speaker: "Soto",
        summary: "With Kuni away, Jia feels increasingly isolated in the high society of Çaruza, struggling to raise her two young children alone. She hires a new housekeeper, an unassuming but preternaturally wise middle-aged woman named Soto. Soto quickly becomes Jia's closest confidante and mentor. It is eventually revealed that Soto is, in fact, Soto Zyndu, Mata's aunt, who was believed to have died years ago after setting fire to her estate to escape the Xana. She has been living in obscurity, secretly observing the world. Seeing Jia's potential, Soto advises her to cast off the passive role expected of her and to fully embrace her power as a political wife, becoming an active and equal partner in shaping Kuni's destiny and the future of Dara.",
    ...
    },
    {
        ...
        speaker: "Mata Zyndu",
        summary: "After conquering the last Imperial holdouts, Mata Zyndu finally learns that Kuni Garu has already captured Pan. Consumed by a paranoid rage and convinced that his sworn brother has betrayed him to steal his glory and the kingship of Géfica promised by the princeps, Mata refuses to listen to reason. He marches his army on the capital but rejects Kuni's peaceful offer to hand over the city. Instead, in a final, terrible act of vengeance against the Xana Empire, he burns Pan to the ground, killing the boy-emperor Erishi in the conflagration. He declares the Princeps's Promise null and void and proclaims himself Hegemon, the new supreme ruler of the Islands of Dara. The friendship between Kuni and Mata is shattered, igniting a new, tragic civil war between the rebellion's two greatest heroes.",
    ...
    },
    {
        ...
        speaker: "Kiji",
        summary: "As Kuni's rebellion gains momentum, Mata Zyndu grows ever more isolated and brutal in his rule. In Çaruza, Mira, the woman from Tunoa whom Mata has taken into his household, becomes an unwitting pawn in the gods' games. The god Kiji, disguised as a beggar, approaches her in the market and gives her a bone dagger—the very one used to murder Phin Zyndu. He urges her to see the Hegemon's true nature, strongly implying that it is her destiny to kill him.\n\nMeanwhile, in Haan, Gin Mazoti and Luan Zya unveil their ultimate weapon. Based on Luan's technical genius and Gin's logistical skill, they have constructed a fleet of mechanical, submersible vessels ingeniously disguised as giant crubens. This revolutionary new technology grants them mastery of the sea from below, allowing them to bypass Mata's naval blockades and land troops anywhere on the Big Island at will, rendering the Hegemon's conventional navy obsolete.",
    ...
    },
    {
        ...
        speaker: "Mata Zyndu",
        summary: "After three more years of grinding war, Mata's forces are starving and on the verge of collapse. Kuni offers a generous peace treaty to divide the islands, which a weary Mata accepts. However, Luan Zya presents Kuni with a parable from his magical book, arguing that true, lasting peace is impossible as long as the two 'crubens'—Kuni and Mata—coexist. Convinced, Kuni makes his most ruthless decision: he breaks the treaty and launches a massive, coordinated surprise attack on Mata's unsuspecting and scattered army.\n\nThe final confrontation occurs at Rana Kida. Mata's army is surrounded and hopelessly outnumbered. Their morale is shattered by a final, clever ploy orchestrated by Lady Risana, who brings the soldiers' wives and mothers to the battlefield to sing songs of peace. Recognizing defeat, Mata makes a last, heroic charge with his most loyal followers. Cornered on a snowy beach, he faces Kuni's army and takes his own life rather than suffer the shame of capture. His tragic death brings the long and devastating Chrysanthemum-Dandelion War to an end.",
