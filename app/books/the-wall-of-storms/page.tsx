...
const chapters = [
    ...
    },
    {
        ...
        quote: "I am willing to drink from this cup for the sake of the empire.",
        speaker: "Consort Risana",
        summary: "In the war's aftermath, a messenger from a distant land arrives: Takval Aragoz, a prince of the Agon people, ancient enemies of the Lyucu. He was carried across the sea in the belly of a whale and brings a gift of fertile garinafin eggs and a proposal for an alliance. Princess Théra, now Empress Üna, accepts a political marriage to forge this crucial alliance. In a bittersweet farewell, she and Zomi Kidosu confess their love, accepting that their duties lie on separate paths. Meanwhile, Empress Jia confronts Consort Risana, arguing Dara cannot afford two rival powers at court and presents her with a cup of 'poisoned' tea as an ultimatum. Risana initially agrees to sacrifice herself, but after testing the tea on a pet rabbit, she discovers it is harmless. She realizes Jia was performing a ruthless political act to manipulate her into a noble suicide. Jia confirms the deception, leaving Risana trapped. To prevent a civil war and protect her son Phyro's future, Risana accepts her tragic fate, ceding total control of the empire to Jia. The book ends as a Lyucu reinforcement fleet is destroyed by the Wall of Storms—Luan Zya's final, posthumous act of sabotage has succeeded.",
        links: [{ name: "Princess Théra", path: "/characters/princess-thera" }, { name: "Zomi Kidosu", path: "/characters/zomi-kidosu" }, { name: "Jia Matiza", path: "/characters/jia-matiza" }, { name: "Consort Risana", path: "/characters/consort-risana" }, { name: "Takval Aragoz", path: "/characters/takval-aragoz" }, { name: "Luan Zya", path: "/characters/luan-zya" }]
    }
];
