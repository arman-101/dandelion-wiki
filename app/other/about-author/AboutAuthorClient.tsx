...
const socialLinks = [
    ...
    { name: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/Ken_Liu', icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M288 288h-64v-64h64v64zm-64 64h64v64h-64v-64zm128-64h64v-64h-64v64zm-128 0h64v-64h-64v64zm-64-128h64V64h-64v64zm192 128h64v-64h-64v64zm-192-192h64V64h-64v64zm192 0h64V64h-64v64zm64 64h64v-64h-64v64zM224 352h64v64h-64v-64zm-64-192v64h-64v-64h64zM96 288v64H32v-64h64zm256-128h64v-64h-64v64zm-64 64h64v-64h-64v64zm-64 64h64v-64h-64v64zm-128-64h64v-64H96v64zm-64 0h64v-64H32v64zm128 128h64v-64h-64v64zm-128 0h64v-64H96v64z" /></svg> },
...
export default function AboutAuthorClient() {
        ...
        <>
            ...
            <div className="max-w-4xl mx-auto px-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 border-b pb-4">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-link dark:text-link-dark tracking-tight">
                        Ken Liu
                    </h1>
                    <BackToHomeButton />
                </div>
