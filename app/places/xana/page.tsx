...
const placeData: Place = {
    ...
    infoBox: {
        ...
        continent: "Dara",
        capital: { text: "Kriphi (on Rui)", link: "/places/kriphi" },
        ImperialCapital: { text: "Pan", link: "/places/pan" },
    ...
    geography: [
        { type: 'text', content: "Xana is an island nation, primarily located on the island of Rui. Its most important geographical feature is Mount Kiji, the sole source of the mystical lift gas that powers its technologically superior airships, giving it a decisive military advantage." },
    ...
    history: [
        {
            ...
            summary: [
                { type: 'text', content: "Led by the ambitious King Réon, Xana used its technological superiority to conquer the six Tiro states, unifying the Islands of Dara for the first time. Réon declared himself Emperor Mapidéré, establishing the Xana Dynasty with its new capital at Pan." },
...
export default function XanaPage() {
    return <XanaClient placeData={placeData} />;
}