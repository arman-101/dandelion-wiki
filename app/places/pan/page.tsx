...
const placeData: Place = {
    ...
    geography: [
        { type: 'text', content: "Pan is a large, strategically located city. Under Emperor Erishi, the Grand Audience Hall was famously redesigned into a giant, interactive map of Dara with wine-filled seas." },
        { type: 'ref', data: { book: "The Grace of Kings", chapter: 9, link: "/books/the-grace-of-kings#chapter-9" } },
    ],
    culture: [
        { type: 'text', content: "As the capital, Pan is the center of high culture, political intrigue, and imperial power. It is home to the most important institutions of the empire, including the Imperial Palace and the Examination Hall, where the Grand Examination is held. The city's atmosphere reflects the nature of its current rulers—decadent and oblivious under Emperor Erishi, but later bustling with innovation and political tension under the Dandelion Dynasty." },
    ...
    history: [
        {
            ...
            summary: [
                { type: 'text', content: "Pan was the seat of power for the Xana emperors. It was here that Lügo Crupo staged his infamous 'deer and horse' incident and where Goran Pira enacted his long-planned revenge, manipulating the court and leading to Crupo's execution." },
        ...
        },
        {
            ...
            summary: [
                { type: 'text', content: "Rebuilt as the capital of the Dandelion Dynasty, Pan became a center for innovation but also a hotbed of political factionalism between the 'Swords' (military old guard) and the 'Abacus' (civil bureaucracy). It was the site of the first Grand Examination, a symbol of the new era's meritocratic ideals. The city was the target of the final, cataclysmic battle against the Lyucu invasion fleet, where the combined forces of the empire made their last stand." },
                { type: 'ref', data: { book: "The Wall of Storms", chapter: 4, link: "/books/the-wall-of-storms#chapter-4" } },
